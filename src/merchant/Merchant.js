<<<<<<< Updated upstream:src/merchant/Merchant.js
...
function Merchant(props) {
  ...
  const transactions = (transactionName, clientIndex) => {
    ...
    var transactionsInfoArray = [<button class="button_cont example_a" rel="nofollow noopener" type="button" id="merchantBox" onClick={() => moveForward(thisMerchIndex, clientIndex, transactionName)}> {returnValue} </button>, 
                                possibleReturns];
    return transactionsInfoArray
  }

  const offersArray = () =>{
    var offersLength = transactions("offers", 0)[1]["offers"].length;
    console.log(transactions("offers", 0)[1]["offers"]);
    var offersList = [];
    for (var i = 0; i < offersLength; i++){
      offersList.push(<span className="box">
      <span className="text">{transactions("offers", i)[0]}</span>
    </span>)
    }
    return offersList
  }
  ...
  return (
      <div>
        ...
        <div className="placeholder">
          ...
          <div className="flex-container">
            <span className="box">
              <span className="text">{transactions("inProgress", 0)[0]}</span>
            </span>
            <span className="box">
              <span className="text">{transactions("inProgress", 1)[0]}</span>
            </span>
            <span className="box">
              <span className="text">{transactions("inProgress", 2)[0]}</span>
            </span>
          </div>
          {/* header bar */}
          <div>
          ...
          <div className="flex-container">
            <span className="box">
              <span className="text">{transactions("doneTran", 0)[0]}</span>
            </span>
            <span className="box">
              <span className="text">{transactions("doneTran", 1)[0]}</span>
            </span>
            <span className="box">
              <span className="text">{transactions("doneTran", 2)[0]}</span>
            </span>
          </div>
        </div>
      </div>
...
>>>>>>> Stashed changes:Nile-frontend/src/merchant/Merchant.js
