<<<<<<< Updated upstream:src/client/Boxes.js
...
function Boxes(props) {
  ...
  var noneOrPassedres = allTransactions(userEmail)["nonePassed"].filter(Boolean);

  var noneArray = [];

  for(let i = 0; i < 3; i ++){
    noneArray.push(<span className="box">
    <span className="text fadeIn" id= "productBox"></span> 
  </span>)
  }

  for (let i = 0; i < noneOrPassedres.length; i++) {
    noneArray[i] = (<span className="box">
    <span className="text fadeIn" id= "productBox">{noneOrPassedres[i]}</span> 
  </span>);
  }

  if (noneArray.length >= 4){
    noneArray.reverse();
  }

  // The side scroller for transactions in progress // 

  var transactionsProgres = allTransactions(userEmail)["prog"].filter(Boolean);
  ...
  for (let i = 0; i < transactionsProgres.length; i++) {
    progArray[i] = (<span className="box">
    <span className="text fadeIn" id= "productBox">{transactionsProgres[i]}</span> 
  </span>);
  } 
  ...
  var finishedTransactions = allTransactions(userEmail)["done"].filter(Boolean);
  ...
  for (let i = 0; i < finishedTransactions.length; i++) {
    finishedArray[i] = (<span className="box">
    <span className="text fadeIn" id= "productBox">{finishedTransactions[i]}</span> 
  </span>);
  } 
...
export default withRouter(Boxes);
>>>>>>> Stashed changes:Nile-frontend/src/client/Boxes.js
