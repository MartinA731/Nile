<<<<<<< Updated upstream:src/client/FirstForm.js
    ...
    return (
        <div className="form-popup" id="firstForm">
            <form action="/action_page.php" className="form-container">
                ...
                <br />
                <select type="password" placeholder="Enter Password" name="psw" id="size">
                    <option value="one">Technology</option>
                    <option value="two">Food and Amenities</option>
                    <option value="three">Clothing</option>
                </select>
                <br />
                <br />
                <button type="button" className="btn" onClick={openSecondForm}>
...
>>>>>>> Stashed changes:Nile-frontend/src/client/FirstForm.js
